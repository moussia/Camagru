...
function send_mail($pseudo, $mail)
{
	...
	$message = 'Bonjour, ' . $pseudo  . ' Pour valider votre compte, veuillez cliquer sur le lien ci dessous : http://localhost:8080/mmottal/index.php?r='.$data['id']. '&controle=accueil&action=home';
